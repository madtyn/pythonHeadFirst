from pythonDesignPatterns.src.composite.menuiterator.waitress import Waitress
from pythonDesignPatterns.src.composite.menuiterator.menu import Menu, MenuItem
